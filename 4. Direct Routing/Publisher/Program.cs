...
namespace RabbitMQ.Examples
{
    class Program
    {
        ...
        private static void CreateConnection()
        {
            ...
            // Criando uma Direct Exchange e declarando as filas específicas.            
            ...
            // Ligando filas ao exchange e a uma routing key
            _model.QueueBind(CardPaymentQueueName, ExchangeName, routingKey:"CardPayment");
            _model.QueueBind(PurchaseOrderQueueName, ExchangeName, routingKey:"PurchaseOrder");
        }
